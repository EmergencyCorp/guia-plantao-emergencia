...
  FileText, Activity, UserCheck, MessageCircle
} from 'lucide-react';
...
          <div className="grid md:grid-cols-2 gap-4">
                ...
                {/* --- NOVO CHAT COM DR. SILIA --- */}
                <FeatureItem 
                    icon={MessageCircle} 
                    color="text-purple-500"
                    title="Chat com Dr. SilIA" 
                    desc="Simulação de caso clínico em tempo real. Discuta a conduta com um Preceptor Sênior (IA) que fornecerá feedback, guias e fará perguntas para aprimorar seu raciocínio."
                />
